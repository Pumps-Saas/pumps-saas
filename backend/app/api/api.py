...
from app.api.v1 import auth, projects, pumps, support, admin, payments, pumps_global

api_router.include_router(auth.router, prefix="/auth", tags=["auth"])
api_router.include_router(admin.router, prefix="/admin", tags=["admin"])
api_router.include_router(projects.router, prefix="/projects", tags=["projects"])
api_router.include_router(pumps.router, prefix="/pumps", tags=["pumps"])
api_router.include_router(pumps_global.router, prefix="/global-pumps", tags=["global-pumps"])
